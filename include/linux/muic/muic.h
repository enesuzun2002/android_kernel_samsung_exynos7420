...
typedef enum {
	...
	ADC_VOL_DN		= 0x0a, /* 0x01010 14.46K ohm */
	ADC_VOL_UP		= 0x0b, /* 0x01011 17.26K ohm */
#endif
	ADC_OPEN		= 0x1f,
...
typedef enum {
	...
	ATTACHED_DEV_EARJACK_SENDKEY,
	ATTACHED_DEV_EARJACK_VOL_DN,
	ATTACHED_DEV_EARJACK_VOL_UP,
#endif
