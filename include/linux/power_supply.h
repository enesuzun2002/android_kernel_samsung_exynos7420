...
enum power_supply_type {
	...
	POWER_SUPPLY_TYPE_HV_PREPARE_MAINS, /* 25 */
	POWER_SUPPLY_TYPE_HV_ERR,			/* 26 */
	POWER_SUPPLY_TYPE_MHL_USB_100,		/* 27 */
	POWER_SUPPLY_TYPE_MHL_2000, 		/* 28 */
	POWER_SUPPLY_TYPE_HV_UNKNOWN,		/* 29 */
	POWER_SUPPLY_TYPE_MDOCK_TA, 		/* Mdock charger(30) */
	POWER_SUPPLY_TYPE_HMT_CONNECTED,	/* 31 */
	POWER_SUPPLY_TYPE_HMT_CHARGE,		/* 32 */
#if defined(CONFIG_BATTERY_SAMSUNG_V2)
...
#else
	POWER_SUPPLY_TYPE_HV_MAINS_CHG_LIMIT,	/* 33 */	
#endif
