...
struct devfreq_clk_state aclk_isp0_trex_532_mfc_pll[] = {
	{MOUT_ACLK_ISP0_TREX_532,	MOUT_MFC_PLL_TOP0},
};
...
struct devfreq_clk_states aclk_isp0_trex_532_mfc_pll_list = {
	.state = aclk_isp0_trex_532_mfc_pll,
	.state_count = ARRAY_SIZE(aclk_isp0_trex_532_mfc_pll),
};
...
struct devfreq_clk_info aclk_isp0_trex_532[] = {
	...
	{INT_LV2,	266 * MHZ,	0,	&aclk_isp0_trex_532_cci_pll_list},
	{INT_LV3,	234 * MHZ,	0,	&aclk_isp0_trex_532_mfc_pll_list},
	{INT_LV4,	133 * MHZ,	0,	&aclk_isp0_trex_532_cci_pll_list},
#else
...
#if defined(CONFIG_ARM_EXYNOS7420_BUS_DEVFREQ_TDNR)
	{INT_LV2,	234 * MHZ,	0,	&aclk_isp0_tpu_590_mfc_pll_list},
	{INT_LV3,	178 * MHZ,	0,	&aclk_isp0_tpu_590_cci_pll_list},
	{INT_LV4,	165 * MHZ,	0,	&aclk_isp0_tpu_590_cam_pll_list},
#else
...
struct devfreq_opp_table devfreq_mif_opp_list[] = {
	...
	{MIF_LV1,	2928000/2,	900000},
	{MIF_LV2,	2528000/2,	900000},
	{MIF_LV3,	2052000/2,	900000},
	{MIF_LV4,	1672000/2,	900000},
	{MIF_LV5,	1270000/2,	900000},
	{MIF_LV6,	1086000/2,	900000},
	{MIF_LV7,	836000/2,	900000},
	{MIF_LV8,	696000/2,	900000},
	{MIF_LV9,	518000/2,	900000},
...
{
	 DREX_TIMING_PARA(0x00002323, 0x46588652, 0x4732BBE0, 0x404A0336, 0x00004E03, 0x00000000, 0x319BA14A, 0x00005DC0, 0x00000101, 0x00000003,
	   0x00211400, 0x00200800|(0x2D<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	 DREX_TIMING_PARA(0x00002121, 0x42588611, 0x4732BBE0, 0x3C460336, 0x00004A03, 0x00000000, 0x319BA14A, 0x00005DC0, 0x00000101, 0x00000003,
	   0x00211400, 0x00200800|(0x2D<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	 DREX_TIMING_PARA(0x00001D1D, 0x3947754F, 0x4632B3DC, 0x343D0335, 0x00004003, 0x00000000, 0x319BA13A, 0x00005DC0, 0x00000101, 0x00000003,
	   0x00211400, 0x00200800|(0x24<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	 DREX_TIMING_PARA(0x00001919, 0x3146648C, 0x3532B39C, 0x2C340335, 0x00003602, 0x00000000, 0x319BA13A, 0x00005DC0, 0x00000101, 0x00000003,
	   0x00211400, 0x00200800|(0x24<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	 DREX_TIMING_PARA(0x00001313, 0x2635538A, 0x3422AAD6, 0x24290234, 0x00002A02, 0x00000000, 0x219BA12A, 0x00FFFFFF, 0x00000000, 0x00000000,
	   0x00211400, 0x00200800|(0x1B<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	 DREX_TIMING_PARA(0x00000F0F, 0x1D2442C8, 0x2322A310, 0x1C1F0233, 0x00002002, 0x00000000, 0x019BA10B, 0x00FFFFFF, 0x00000000, 0x00000000,
	 ...
	 DREX_TIMING_PARA(0x00000808, 0x19232185, 0x22229ACC, 0x101F0233, 0x00001202, 0x00000000, 0x019BA0FA, 0x00FFFFFF, 0x00000000, 0x00000000,
	   0x00211400, 0x00200800|(0x09<<2), 0x00221800 | (0x24<<2), 0x00210c00|(0x00<<2), 0x00211800|(0x0F<<2), 0x00000000),
	 DREX_TIMING_PARA(0x00000606, 0x19232144, 0x22229286, 0x0C1F0233, 0x00000D02, 0x00000000, 0x019BA0EA, 0x00FFFFFF, 0x00000000, 0x00000000,
...
{
	DREX_TIMING_PARA(0x00002323, 0x46588652, 0x4732BBE0, 0x404A0336, 0x00004E03, 0x00000000, 0x319BA14A, 0x00005DC0, 0x01010101, 0x00000003,
			0x00211400, 0x00200800|(0x2D<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	DREX_TIMING_PARA(0x00002121, 0x42588611, 0x4732BBE0, 0x3C460336, 0x00004A03, 0x00000000, 0x319BA14A, 0x00005DC0, 0x01010101, 0x00000003,
			0x00211400, 0x00200800|(0x2D<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	DREX_TIMING_PARA(0x00001D1D, 0x3947754F, 0x4632B3DC, 0x343D0335, 0x00004003, 0x00000000, 0x319BA13A, 0x00005DC0, 0x01010101, 0x00000003,
			0x00211400, 0x00200800|(0x24<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
...
static struct dmc_phy_dfs_mif_table dfs_phy_mif_table[] =
{
	...
	PHY_DVFS_CON(0x82200000|(dvfs_dqs_osc_en<<17), 0x41100000|(dvfs_dqs_osc_en<<16), PHY_DVFS_CON0_SET1_MASK, PHY_DVFS_CON0_SET0_MASK,
			0x2000B000, 0x002000B0, PHY_DVFS_CON1_SET1_MASK, PHY_DVFS_CON1_SET0_MASK,
			0x20000000, 0x00400000, PHY_DVFS_CON2_SET1_MASK, PHY_DVFS_CON2_SET0_MASK,
			0x085B8000, 0x040005B8, PHY_DVFS_CON3_SET1_MASK, PHY_DVFS_CON3_SET0_MASK,
			0x00000000, 0x00000000, PHY_DVFS_CON4_SET1_MASK, PHY_DVFS_CON4_SET0_MASK,
			0x80700000, 0x40070000, PHY_DVFS_CON5_SET1_MASK, PHY_DVFS_CON5_SET0_MASK),
	PHY_DVFS_CON(0x82200000|(dvfs_dqs_osc_en<<17), 0x41100000|(dvfs_dqs_osc_en<<16), PHY_DVFS_CON0_SET1_MASK, PHY_DVFS_CON0_SET0_MASK,
	...
	PHY_DVFS_CON(0x82200000|(dvfs_dqs_osc_en<<17), 0x41100000|(dvfs_dqs_osc_en<<16), PHY_DVFS_CON0_SET1_MASK, PHY_DVFS_CON0_SET0_MASK,
			...
			0x20000000, 0x00400000, PHY_DVFS_CON2_SET1_MASK, PHY_DVFS_CON2_SET0_MASK,
			0x00344000, 0x00000344, PHY_DVFS_CON3_SET1_MASK, PHY_DVFS_CON3_SET0_MASK,
			0x00000000, 0x00000000, PHY_DVFS_CON4_SET1_MASK, PHY_DVFS_CON4_SET0_MASK,
	...
	PHY_DVFS_CON(0x82200000|(dvfs_offset<<8)|(dvfs_dqs_osc_en<<17),	0x41100000|(dvfs_offset<<0)|(dvfs_dqs_osc_en<<16), PHY_DVFS_CON0_SET1_MASK, PHY_DVFS_CON0_SET0_MASK,
			...
			0x20000000, 0x00400000, PHY_DVFS_CON2_SET1_MASK, PHY_DVFS_CON2_SET0_MASK,
			0x0027B000, 0x0000027B, PHY_DVFS_CON3_SET1_MASK, PHY_DVFS_CON3_SET0_MASK,
			0x00000000, 0x00000000, PHY_DVFS_CON4_SET1_MASK, PHY_DVFS_CON4_SET0_MASK,
			0x00501000, 0x00050100, PHY_DVFS_CON5_SET1_MASK, PHY_DVFS_CON5_SET0_MASK),
#ifdef L6_RL_WL_DECREASE
	PHY_DVFS_CON(0x82200000|(dvfs_offset<<8)|(dvfs_dqs_osc_en<<17),	0x41100000|(dvfs_offset<<0)|(dvfs_dqs_osc_en<<16), PHY_DVFS_CON0_SET1_MASK, PHY_DVFS_CON0_SET0_MASK,
	...
	PHY_DVFS_CON(0x82200000|(dvfs_offset<<8)|(dvfs_dqs_osc_en<<17), 0x41500000|(dvfs_offset<<0)|(dvfs_dqs_osc_en<<16), PHY_DVFS_CON0_SET1_MASK, PHY_DVFS_CON0_SET0_MASK,
			...
			0x20000000, 0x00400000, PHY_DVFS_CON2_SET1_MASK, PHY_DVFS_CON2_SET0_MASK,
			0x001A2000, 0x000001A2, PHY_DVFS_CON3_SET1_MASK, PHY_DVFS_CON3_SET0_MASK,
			0x00000000, 0x00000000, PHY_DVFS_CON4_SET1_MASK, PHY_DVFS_CON4_SET0_MASK,
...
static void exynos7_devfreq_thermal_monitor(struct work_struct *work)
{
	...
	if (data_mif->mem_density == LP4_12Gb_Die && thermal_work->min_freq != min_freq) {
		thermal_work->min_freq = min_freq;
		if (pm_qos_request_active(&min_mif_thermal_qos))
			pm_qos_update_request(&min_mif_thermal_qos, min_freq);
	}
...
void exynos7_devfreq_set_tREFI_1x(struct devfreq_data_mif *data)
{
	...
	for (i = 0; i< MIF_BLK_NUM; i++) {
		...
		if (timingaref_value == RATE_TWO || timingaref_value == RATE_FOUR)
