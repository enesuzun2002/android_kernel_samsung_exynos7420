...
#define MDNIE_RED_R		18		/* ASCR_WIDE_CR[7:0] */
#define MDNIE_RED_G		20		/* ASCR_WIDE_CG[7:0] */
#define MDNIE_RED_B		22		/* ASCR_WIDE_CB[7:0] */
#define MDNIE_BLUE_R		24		/* ASCR_WIDE_MR[7:0] */
#define MDNIE_BLUE_G		26		/* ASCR_WIDE_MG[7:0] */
#define MDNIE_BLUE_B		28		/* ASCR_WIDE_MB[7:0] */
#define MDNIE_GREEN_R		30		/* ASCR_WIDE_YR[7:0] */
#define MDNIE_GREEN_G		32		/* ASCR_WIDE_YG[7:0] */
#define MDNIE_GREEN_B		34		/* ASCR_WIDE_YB[7:0] */
#define MDNIE_WHITE_R		36		/* ASCR_WIDE_WR[7:0] */
#define MDNIE_WHITE_G		38		/* ASCR_WIDE_WG[7:0] */
#define MDNIE_WHITE_B		40		/* ASCR_WIDE_WB[7:0] */
...
static unsigned char coordinate_data_1[][3] = { // lihh, TBD
...
static unsigned char coordinate_data_2[][3] = { // lihh, TBD
	{0xff, 0xff, 0xff}, /* dummy */
	{0xff, 0xf6, 0xed}, /* Tune_1 */
	{0xff, 0xf6, 0xed}, /* Tune_2 */
	{0xff, 0xf6, 0xed}, /* Tune_3 */
	{0xff, 0xf6, 0xed}, /* Tune_4 */
	{0xff, 0xf6, 0xed}, /* Tune_5 */
	{0xff, 0xf6, 0xed}, /* Tune_6 */
	{0xff, 0xf6, 0xed}, /* Tune_7 */
	{0xff, 0xf6, 0xed}, /* Tune_8 */
	{0xff, 0xf6, 0xed}, /* Tune_9 */
};
...
static unsigned char GRAYSCALE_1[] = {//lihh TBD
	0xEC,
	0x00, //roi ctrl
	0x00, //roi0 x start
	0x00,
...
static unsigned char COLOR_BLIND_HBM_2[] = { //lihh TBD
	//start
	0xEB,
	0x01, //mdnie_en
	0x00, //data_width mask 00 000
...
static unsigned char COLOR_BLIND_HBM_1[] = { //lihh TBD
	0xEC,
	0x00, //roi ctrl
	0x00, //roi0 x start
	0x00,
...
static unsigned char HMT_GRAY_8_2[] = {// lihh TBD
	/* start */
	0xEB,
	0x01, /* mdnie_en */
	0x00, /* data_width mask 00 0000 */
...
static unsigned char HMT_GRAY_8_1[] = {// lihh TBD
	0xEC,
	0x98, /* lce_on gain 0 00 0000 */
	0x24, /* lce_color_gain 00 0000 */
	0x10, /* lce_scene_change_on scene_trans 0 0000 */
...
static unsigned char HMT_GRAY_16_2[] = {// lihh TBD
	/* start */
	0xEB,
	0x01, /* mdnie_en */
	0x00, /* data_width mask 00 0000 */
...
static unsigned char HMT_GRAY_16_1[] = {// lihh TBD
	0xEC,
	0x98, /* lce_on gain 0 00 0000 */
	0x24, /* lce_color_gain 00 0000 */
	0x10, /* lce_scene_change_on scene_trans 0 0000 */
...
static unsigned char LOCAL_CE_2[] = {//lihh DSI0_HBM_CE_MDNIE_1?
	//start
	0xEB,
	0x01, //mdnie_en
	0x00, //data_width mask 00 000
...
static unsigned char LOCAL_CE_1[] = {//lihh DSI0_HBM_CE_MDNIE_2?
	0xEC,
	0x00, //roi ctrl
	0x00, //roi0 x start
	0x00,
...
static unsigned char LOCAL_CE_TEXT_2[] = {//DSI0_HBM_CE_TEXT_MDNIE_1
	//start
	0xEB,
	0x01, //mdnie_en
	0x00, //data_width mask 00 000
...
static unsigned char LOCAL_CE_TEXT_1[] = {//DSI0_HBM_CE_TEXT_MDNIE_2
	0xEC,
	0x00, //roi ctrl
	0x00, //roi0 x start
	0x00,
...
static unsigned char HMT_3000K_2[] = {//lihh TBD
	/* start */
	0xEB,
	0x01, //mdnie_en
	0x00, //data_width mask 00 0000
...
static unsigned char HMT_3000K_1[] = {//lihh TBD
	0xEC,
	0x98, //lce_on gain 0 00 0000
	0x24, //lce_color_gain 00 0000
	0x10, //lce_scene_change_on scene_trans 0 0000
...
static unsigned char HMT_4000K_2[] = {//lihh TBD
	/* start */
	0xEB,
	0x01, //mdnie_en
	0x00, //data_width mask 00 0000
...
static unsigned char HMT_4000K_1[] = {//lihh TBD
	0xEC,
	0x98, //lce_on gain 0 00 0000
	0x24, //lce_color_gain 00 0000
	0x10, //lce_scene_change_on scene_trans 0 0000
...
static unsigned char HMT_5000K_2[] = {//lihh TBD
	/* start */
	0xEB,
	0x01, //mdnie_en
	0x00, //data_width mask 00 0000
...
static unsigned char HMT_5000K_1[] = {//lihh TBD
	0xEC,
	0x98, //lce_on gain 0 00 0000
	0x24, //lce_color_gain 00 0000
	0x10, //lce_scene_change_on scene_trans 0 0000
...
static unsigned char HMT_6500K_2[] = {//lihh TBD
	/* start */
	0xEB,
	0x01, //mdnie_en
	0x00, //data_width mask 00 0000
...
static unsigned char HMT_6500K_1[] = {//lihh TBD
	0xEC,
	0x98, //lce_on gain 0 00 0000
	0x24, //lce_color_gain 00 0000
	0x10, //lce_scene_change_on scene_trans 0 0000
