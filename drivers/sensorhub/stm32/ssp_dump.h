...
/* dumpregister size*/
#define DUMPREGISTER_SIZE_ACCELEROMTER          64
#define DUMPREGISTER_SIZE_GEOMAGNETIC_FIELD	48
...
#define SENSOR_DUMP_SENSOR_LIST 	{SENSOR_TYPE_ACCELEROMETER, SENSOR_TYPE_GEOMAGNETIC_FIELD, \
