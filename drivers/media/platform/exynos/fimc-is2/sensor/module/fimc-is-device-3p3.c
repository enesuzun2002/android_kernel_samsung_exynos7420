...
static struct fimc_is_sensor_cfg config_3p3[] = {
	...
	/* 1152X648@120fps */
	FIMC_IS_SENSOR_CFG(1152, 648, 120, 30, 2),
	/* 1152X864@120fps */
	FIMC_IS_SENSOR_CFG(1152, 864, 120, 30, 3),
	/* 2312X1732@30fps */
	FIMC_IS_SENSOR_CFG(2312, 1732, 30, 30, 4),
	/* 2312X1732@15fps */
	FIMC_IS_SENSOR_CFG(2312, 1732, 15, 30, 5),
	/* 2312X1300@30fps */
	FIMC_IS_SENSOR_CFG(2312, 1300, 30, 30, 6),
};
		...
		struct exynos_platform_fimc_is_module *pdata)
{
	...
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "VDDA_2.9V_CAM", PIN_REGULATOR, 1, 0);
